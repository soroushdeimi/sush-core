...
def main():
    ...
    test_results = []
    # Smoke test
    test_results.append(run_command(["python", "tests/test_smoke.py"], "Smoke Test"))

    # Core component validation
    test_results.append(
        run_command(["python", "tests/test_core_components.py"], "Core Components Test")
    )

    # Integration validation
    test_results.append(run_command(["python", "tests/test_integration.py"], "Integration Test"))

    # Comprehensive system test
    test_results.append(
        run_command(["python", "tests/test_comprehensive.py"], "Comprehensive System Test")
    )
